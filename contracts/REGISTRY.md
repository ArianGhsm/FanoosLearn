...
| Bot academic/content reads | internal v1 schedule/grades/announcements/resource catalog endpoints | Academic/Content integration | Telegram, Bale | Canonical linked user + active workspace membership + scoped authorization on every request; bounded pagination; no storage paths | Integration/baseline stage |
