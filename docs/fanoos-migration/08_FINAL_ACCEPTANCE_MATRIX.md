...
| Web UX | UX wave | PHP shell + `assets/ui-v3` app bootstrap | UX reports | web UX/fuzz CI | Persian RTL/accessibility/domain renderers | iOS/Android/desktop/browser + screen-reader smoke | PASS_WITH_RUNTIME_VALIDATION | Low |
