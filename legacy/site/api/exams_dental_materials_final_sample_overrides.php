...
require_once __DIR__ . '/exams_dental_materials_final_sample_data.php';

function dent_exams_apply_dental_materials_final_sample_catalog_overrides(array $bank): array
{
    ...
    $course = dent_exams_dental_materials_final_sample_course();
