...
require_once __DIR__ . '/exams_diagnostics2_final_sample_data.php';

function dent_exams_apply_diagnostics2_final_sample_catalog_overrides(array $bank): array
{
    ...
    $course = dent_exams_diagnostics2_final_sample_course(false);
    ...
    foreach ($courses as $slug => $existingCourse) {
        ...
        if (!$inserted && $slug === 'diagnostics-2-term6') {
