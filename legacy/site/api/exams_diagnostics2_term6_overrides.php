...
require_once __DIR__ . '/exams_diagnostics2_term6_data.php';

function dent_exams_apply_diagnostics2_term6_catalog_overrides(array $bank): array
{
    ...
    $course = dent_exams_diagnostics2_term6_course(false);
    ...
    foreach ($courses as $slug => $existingCourse) {
        ...
        if (!$inserted && $slug === 'diagnostics-1-term6') {
