...
require_once __DIR__ . '/exams_equipment_ergonomics_term6_final_sample_data.php';

function dent_exams_apply_equipment_ergonomics_term6_final_sample_catalog_overrides(array $bank): array
{
    ...
    $course = dent_exams_equipment_ergonomics_term6_final_sample_course();
    ...
    foreach ($courses as $existingSlug => $existingCourse) {
        ...
        if ($existingSlug === 'gerontology-term-6-final-sample') {
            $rebuilt[$slug] = $course;
            $inserted = true;
        }
    }
