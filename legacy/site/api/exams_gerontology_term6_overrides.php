...
require_once __DIR__ . '/exams_gerontology_term6_data.php';

function dent_exams_apply_gerontology_term6_catalog_overrides(array $bank): array
{
    ...
    $course = dent_exams_gerontology_term6_course();
