...
class FanoosApiClient:
    ...
    def media_forensic_source(self,platform,subject,workspace_id,object_id,resource_version_id,classification,max_bytes):return self.post_binary('/api/internal/v1/protected-media/forensic/source',{'platform':platform,'subject':str(subject),'workspace_id':workspace_id,'object_id':object_id,'resource_version_id':resource_version_id,'classification':classification},max_bytes=max_bytes,safe_to_retry=False)
